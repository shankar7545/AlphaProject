...
public class BronzeFragment extends Fragment {
    ...
    TextView referCount, transactionCount, upgradeTextView, statusText;
    ImageView referImageView, transactionImageView;
    RelativeLayout referRelative, transactionRelative, statusRelative;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        statusRelative = mView.findViewById(R.id.statusRelative);
            ...
            mTransactions.child("count").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (countLevelOne.equals("2")) {
                        ...
                        statusRelative.setBackgroundResource(R.drawable.shape_round_solid_green);
                        statusRelative.removeAllViews();
                        ...
                        statusRelative.addView(img2);


                        statusText.setText("You are now eligible to Upgrade");
    ...
    private void checkUpgrade() {
        ...
        mUsers.child(selfUid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String mAchievement = dataSnapshot.child("Achievement").getValue().toString();
                if (!mAchievement.equals("Bronze")) {
                    statusText.setText("Upgrade Successfull");
                    upgradeLayoutBronze.setEnabled(true);
                    upgradeLayoutBronze.setBackgroundColor(getResources().getColor(R.color.green_800));
                    upgradeTextView.setText("U P G R A D E   C O M P L E T E D");
                    upgradeLayoutBronze.setOnClickListener(v -> Toast.makeText(getContext(), "Upgrade Completed", Toast.LENGTH_SHORT).show());
                }
        ...
        mFirebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (p2Status.equals("free")) {
                    ...
                    Toast.makeText(getContext(), " Parent wallet is busy , trying again in 15 seconds", Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                    upgradeProgressBar.setVisibility(View.GONE);
                    upgradeTextView.setVisibility(View.VISIBLE);
