                ...
                String transType = model.getTransactionType();
                {
                    switch (transType) {
                        case "credited":
                            ...
                            holder.transactionImage.setColorFilter(ContextCompat.getColor(getContext(), R.color.blue));
                        ...
                        case "debited":
                            ...
                            holder.transactionImage.setColorFilter(ContextCompat.getColor(getContext(), R.color.red_700));
                        ...
                        case "added":
                            ...
                            holder.walletImage.setColorFilter(ContextCompat.getColor(getContext(), R.color.white));
